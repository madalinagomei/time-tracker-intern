...
export function UserRowLine({
  ...
  return (
    <div
      className={[
        "grid border-b border-slate-200/80 dark:border-zinc-900",
        isMoveTarget ? "bg-sky-50/80 dark:bg-sky-950/15" : "",
      ].join(" ")}
      style={{ gridTemplateColumns: `${leftWidth}px 1fr` }}
    >
      <div
        className={[
          "sticky left-0 z-10 border-r border-slate-200/70 bg-white/95 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/95",
      ...
      >
        ...
        {isMoveTarget ? (
          <div className="pointer-events-none absolute inset-0 z-[1] bg-gradient-to-r from-sky-100/55 via-sky-50/35 to-transparent ring-1 ring-inset ring-sky-300/60 dark:from-sky-950/35 dark:via-sky-950/10 dark:ring-sky-700/45" />
        ) : null}
        ...
        {ghostAssignment ? (() => {
          ...
          return (
            <div
              className="pointer-events-none absolute z-[2] rounded-[14px] border border-dashed border-slate-400/45 bg-slate-200/20 shadow-[inset_0_0_0_1px_rgba(148,163,184,0.16)] dark:border-zinc-500/40 dark:bg-zinc-200/5"
              style={{
                ...
                height: barHeight,
                boxShadow: `0 0 0 1px rgba(255,255,255,0.04), inset 0 0 0 1px rgba(0,0,0,0.02)`,
              }}
              aria-hidden="true"
            >
              <div
                className={[
                  "h-full w-full rounded-[13px] opacity-35",
            ...
            lane.map((item) => {
              ...
              return (
                <div
                  ...
                  className={[
                    "group pointer-events-auto absolute flex items-center overflow-hidden rounded-[14px] border text-left font-semibold tracking-[0.01em] shadow-sm transition-[box-shadow,transform]",
                    isCompact ? "text-[11px]" : "text-[12px]",
                    visual.barClassName,
                    item.leave || isTransientPreview ? "border-dashed" : "",
                    isDraft
                      ? "ring-2 ring-sky-300/80 ring-offset-1 ring-offset-white dark:ring-sky-600/80 dark:ring-offset-zinc-950"
                      : isDuplicatePreview
                        ? "opacity-95 ring-2 ring-sky-200/80 ring-offset-1 ring-offset-white shadow-[0_12px_28px_rgba(14,165,233,0.18)] dark:ring-sky-700/60 dark:ring-offset-zinc-950"
                      : "hover:-translate-y-px hover:shadow-md",
                    isActiveMovePreview
                      ? "z-10 -translate-y-0.5 opacity-95 ring-2 ring-sky-300/80 ring-offset-1 ring-offset-white shadow-[0_12px_30px_rgba(14,165,233,0.22)] dark:ring-sky-700/60 dark:ring-offset-zinc-950"
                      : "",
                    isSelected && !isActiveMovePreview
                      ? "ring-2 ring-slate-300/80 ring-offset-1 ring-offset-white dark:ring-zinc-700/80 dark:ring-offset-zinc-950"
                      : "",
                    contentPaddingClass,
                  ].join(" ")}
                ...
                >
                  ...
                  {!isTransientPreview && showInlineActions ? (
                    <div className="pointer-events-auto flex items-center gap-1 pl-1.5">
                      <button
                        ...
                        className="rounded-md px-1.5 py-0.5 text-[10px] font-medium text-current/75 opacity-0 transition group-hover:opacity-100 hover:bg-black/10"
                      >
                        Open
                      </button>
                  ...
                  {!isTransientPreview && showOverflowActions ? (
                    <button
                      ...
                      className={[
                        "absolute right-1 top-1/2 z-[4] flex h-5 w-5 -translate-y-1/2 items-center justify-center rounded-full bg-black/10 text-[11px] font-bold text-current/80 transition hover:bg-black/20 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300 dark:bg-black/20 dark:hover:bg-black/35",
        ...
        {hoveredTooltip ? (
          <div
            className="pointer-events-none fixed z-[90] w-[248px] rounded-2xl border border-slate-200/90 bg-white/98 px-3 py-2.5 shadow-2xl backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/96"
            style={{
        ...
        {actionMenu ? (
          <div
            ref={actionMenuRef}
            className="fixed z-[80] w-[156px] rounded-2xl border border-slate-200/80 bg-white p-1.5 shadow-2xl dark:border-zinc-800 dark:bg-zinc-950"
            style={{
          ...
          >
            <button
              ...
              className="flex w-full items-center justify-between rounded-xl px-3 py-2 text-left text-sm font-medium text-slate-700 transition hover:bg-slate-100 dark:text-zinc-200 dark:hover:bg-zinc-900"
            >
              <span>Open</span>
            ...
            <button
              ...
              className="flex w-full items-center justify-between rounded-xl px-3 py-2 text-left text-sm font-medium text-rose-600 transition hover:bg-rose-50 dark:text-rose-300 dark:hover:bg-rose-950/30"
            >
              <span>Delete</span>
